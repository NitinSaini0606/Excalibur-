...
//       method: "POST",
//       headers: { "Content-Type": "application/json" },
//       body: JSON.stringify({ question: userInput }) // <-- key should be "question"
//     });
//     const data = await response.json();
//     return data.answer;
//   } catch (err) {
...
//     const botAnswer = await getBotResponse(userMessage.text);
//     const botMessage = {
//       id: messages.length + 2,
//       type: 'bot',
//       text: botAnswer
...
//           </div>
//         </div>
//         <button onClick={onClose} style={{ background: 'none', border: 'none', color: 'white', cursor: 'pointer', padding: '4px', borderRadius: '4px', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
//           <X size={20} />
//         </button>
//       </div>
...
//         {messages.map((message) => (
//           <div key={message.id} style={{ display: 'flex', alignItems: 'flex-start', gap: '12px', flexDirection: message.type === 'user' ? 'row-reverse' : 'row' }}>
//             <div style={{ backgroundColor: message.type === 'user' ? '#2ecc71' : '#40444b', borderRadius: '50%', padding: '6px', display: 'flex', alignItems: 'center', justifyContent: 'center', minWidth: '32px', height: '32px' }}>
//               {message.type === 'user' ? <User size={16} color="white" /> : <Bot size={16} color="white" />}
//             </div>
//             <div style={{ backgroundColor: message.type === 'user' ? '#2ecc71' : '#5865f2', color: 'white', padding: '12px 16px', borderRadius: '16px', maxWidth: '70%', fontSize: '14px', lineHeight: '1.4', wordWrap: 'break-word' }}>
//               {message.text}
//             </div>
//           </div>
//         ))}
...
//             <div style={{ backgroundColor: '#40444b', borderRadius: '50%', padding: '6px', display: 'flex', alignItems: 'center', justifyContent: 'center', minWidth: '32px', height: '32px' }}>
//               <Bot size={16} color="white" />
//             </div>
//             <div style={{ backgroundColor: '#40444b', color: 'white', padding: '12px 16px', borderRadius: '16px', fontSize: '14px' }}>
//               <span style={{ opacity: 0.7 }}>Typing...</span>
//             </div>
//           </div>
//         )}
...
//             onKeyPress={handleKeyPress}
//             placeholder="Type your message..."
//             style={{ flex: 1, padding: '12px 16px', backgroundColor: '#40444b', color: 'white', border: 'none', borderRadius: '24px', fontSize: '14px', outline: 'none' }}
//           />
//           <button onClick={handleSendMessage} disabled={!inputValue.trim()} style={{ backgroundColor: inputValue.trim() ? '#5865f2' : '#72767d', color: 'white', border: 'none', borderRadius: '50%', width: '40px', height: '40px', display: 'flex', alignItems: 'center', justifyContent: 'center', cursor: inputValue.trim() ? 'pointer' : 'not-allowed', transition: 'background-color 0.2s' }}>
//             <Send size={16} />
//           </button>
//         </div>
//       </div>
...
//         method: "POST",
//         headers: { "Content-Type": "application/json" },
//         body: JSON.stringify({ question: userInput }) // <-- must match FastAPI
//       });
//       const data = await response.json();
//       return data.answer;
//     } catch (err) {
...
//   // --------------------- NEW: FastAPI backend call ---------------------
//   const getBotResponse = async (userInput) => {
//     try {
//       const response = await fetch("http://127.0.0.1:8000/chat", {
//         method: "POST",
//         headers: { "Content-Type": "application/json" },
//         body: JSON.stringify({ question: userInput }), // must match FastAPI model
//       });
//       const data = await response.json();
//       return data.answer;
//     } catch (error) {
...
// // --------------------- ResourceHub component remains the same ---------------------
// const ResourceHub = () => {
//   const [searchTerm, setSearchTerm] = useState('');
//   const [selectedCategory, setSelectedCategory] = useState('all');
//   const [selectedLanguage, setSelectedLanguage] = useState('all');
...
//   // ... rest of ResourceHub code remains completely unchanged

//   return (
//     <div className="container" style={{ padding: '40px 20px' }}>
//       {/* ... ResourceHub JSX remains unchanged ... */}
//       <SimpleChatbot isOpen={chatbotOpen} onClose={() => setChatbotOpen(false)} />
//       {!chatbotOpen && (
//         <button
//           onClick={() => setChatbotOpen(true)}
...
// import React, { useState, useRef, useEffect } from "react";
// import { Bot, User, X, MessageCircle, Send } from "lucide-react";
...
//     const question = inputValue; // Capture input before clearing
//     const userMessage = {
//       id: Date.now(),
//       type: "user",
//       text: question
...
//             <div
//               style={{
//                 backgroundColor: m.type === "user" ? "#2ecc71" : "#40444b",
//                 borderRadius: "50%",
//                 padding: "6px",
//                 minWidth: "32px",
//                 height: "32px",
...
//             <div
//               style={{
//                 backgroundColor: m.type === "user" ? "#2ecc71" : "#5865f2",
//                 color: "white",
//                 padding: "12px 16px",
//                 borderRadius: "16px",
//                 maxWidth: "70%",
...
// const SimpleChatbot = () => {
//   const [messages, setMessages] = useState([
//     { type: "bot", text: "Hello! I am your AI mental health assistant." },
//   ]);
