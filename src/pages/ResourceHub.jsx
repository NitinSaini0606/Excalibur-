...
// import { Search, Play, BookOpen, Headphones, ExternalLink, Filter, MessageCircle, Send, X, Bot, User } from 'lucide-react';

// // Simple chatbot component without external dependencies
...
//         // Simple chatbot component using FastAPI
...
//       setMessages(prev => [
//         ...prev,
//         { id: messages.length + 2, type: 'bot', text: "Sorry, I'm having trouble connecting to the server." }
//       ]);
//       console.error(err);
//     } finally {
//       setIsTyping(false);
...
//   return (
//     <div className="container" style={{ padding: '40px 20px' }}>
//       <h1 style={{ marginBottom: '24px' }}>Resource Hub</h1>
...
// Chatbot component using FastAPI
const SimpleChatbot = ({ isOpen, onClose }) => {
  const [messages, setMessages] = useState([
    { id: 1, type: 'bot', text: "Hello! I'm your AI mental health assistant. How can I help you today?" }
  ]);
